...
* https://github.com/aenniw/ARDUINO/tree/master/skarsta (for the 3d-printing layouts and the idea with sonar + 7-segment display)

## The required parts:
* Arduino Uno
* L298N Motor Driver
* 2 x 24v DC Motors (23kg.cm torque)
* 2 x L-Bracket for Motor - $8
* 24v 6A AC/DC Adapter
* 4x Push Buttons - $2
* 4x 10k OHM Resistors
* 2 x Motor Shaft Coupling (6mm to 6 or 7mm) - $7
* Barrel Jack to Cable adapter - $8
